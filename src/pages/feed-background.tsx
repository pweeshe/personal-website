...
const Home: NextPage = () => {
  return (
    <>
      ...
      <Link href="/home">
        <div className="fixed left-12 top-12 flex items-center gap-2 rounded-xl bg-white-half px-4 py-2 font-medium hover:fill-white hover:text-white md:left-24">
          <BackArrowIcon />
          Back home
        </div>
      </Link>
